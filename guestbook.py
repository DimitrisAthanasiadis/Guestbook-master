...
class User(db.Model, fl.UserMixin):
    ...
    def __init__(self, username, password, email):
        ...
        # oi parakatw dyo metavlhtes an mpoun tha exoume errors. den mporei na tis thesei opws prepei
...
def login_required(function):
    ...
    def wrapper():
        ...
        if not fl.current_user.is_authenticated:
            ...
            # abort()
            return render_template("login.html", form=form, current_user=fl.current_user)
...
def login_process():
    ...
    # if exists == True:
    # logged_in = True
    fl.current_user.is_authenticated = True
